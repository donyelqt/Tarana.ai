...
**Current next-task ranking after PR #592:**
1. **Decide monitor route scope** — keep, rewrite, or delete the unauthenticated stateful placeholder before adding observability.
