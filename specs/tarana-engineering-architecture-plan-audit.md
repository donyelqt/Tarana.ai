...
**Current next-task ranking after PR #574:**
No ranked implementation task remains in the dead-file cleanup lane. The three standalone diagnostic scripts are explicitly retained; revisit them only with a product or maintenance decision.
...
The multi-agent generator idempotency gap is closed by PR #571, refresh-to-generator forwarding by PR #572, parser logging by PR #573, and approved production dead-file cleanup by PR #574. The remaining standalone diagnostics are intentionally retained.
