...
| [x] | 2.3 slices 1–1b–2–R3–R4–R5–R6 | Idempotency keys (saved-itineraries POST+PATCH, saved-meals POST+DELETE, profile PATCH, generator POST) | **6 of N write endpoints.** R6 (PR #564, merged `4b13d85`) extends the shared claim/complete pattern to the last charge-first route without a key contract (`POST /api/gemini/itinerary-generator`); see the 2.3-R6 row for the full record. |
