          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-gray-600">
                No more guesswork. Just tell us what you love — food, culture, nature, chill vibes — and we'll do the
                rest.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-gray-600">
                Go beyond the usual. Discover authentic Baguio spots curated with help from locals, bloggers, and
                community partners.
              </p>
            </div>
          </div>
