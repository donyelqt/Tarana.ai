        ...
        <section className="w-full px-4 py-8">
            <div className="max-w-7xl mx-auto">
                <div className="bg-gray-50 rounded-[2rem] overflow-hidden shadow-sm relative">
                    ...
                    <div className="relative z-10 px-8 pt-16 pb-20 md:px-16 md:pt-20 md:pb-24 flex flex-col items-center">
                        {/* Heading */}
                        <h1 className="text-4xl md:text-6xl font-bold text-center mb-6 max-w-4xl">
                            Plan Your Perfect <span className="text-blue-500">Baguio Trip</span>
                            <br />
                            in Seconds
                        </h1>
                        ...
                        <div className="absolute bottom-1">
                            <Link
                                href="#"
                                className="bg-blue-600 text-white px-8 py-3 rounded-2xl text-lg font-medium hover:bg-blue-700 transition-colors flex items-center"
                            >
                                Plan My Baguio Trip
                    ...
                    {/* Background Image */}
                    <div className="rounded-xl overflow-hidden shadow-2xl h-[80px]">
