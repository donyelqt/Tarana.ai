...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "bg-background group/calendar calendar-responsive p-1 [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent",
      ...
      classNames={{
        ...
        dropdowns: cn(
          "flex h-[--cell-size] w-full items-center justify-center gap-0.5 text-xs font-medium",
        ...
        caption_label: cn(
          ...
          captionLayout === "label"
            ? "text-xs"
            : "[&>svg]:text-muted-foreground flex h-6 items-center gap-0.5 rounded-md pl-2 pr-1 text-xs [&>svg]:size-3.5",
